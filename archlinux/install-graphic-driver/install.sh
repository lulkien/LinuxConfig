...
if [[ "$is_nvidia" = true ]]; then
	...
	echo -e ' - Remove \e[1;33mkms\e[00m from \e[1;33mHOOKS=(...)\e[00m if it exists.'
	echo -e ' - Save and quit.'
	echo -e ' - Regenerate the initramfs with: \e[1;32msudo mkinitcpio -P\e[00m'

	echo
	echo -e '3. Adding the Pacman Hook:'
	echo -e ' - Open \e[1;33mnvidia.hook\e[00m file, you can find it at the location of this script.'
	echo -e ' - Uncomment the correct driver you installed.'
	echo -e ' - Create directory \e[1;33m/etc/pacman.d/hooks\e[00m if not existed.'
	echo -e ' - Copy the \e[1;33mnvidia.hook\e[00m into that path.'

function deploy-standby
    ...
    # system variable
    set -g source_qml '/home/kienlh4ivi/working/source-code/AppStandbyClock/qml'
    set -g release_bin '/home/kienlh4ivi/working/build/AppStandbyClock/app/bin/AppStandbyClock'
    set -g release_share '/home/kienlh4ivi/working/build/AppStandbyClock/app/share/AppStandbyClock'
    set -g strip_path '/usr/local/oecore-x86_64/sysroots/x86_64-oesdk-linux/usr/bin/x86_64-oe-linux/x86_64-oe-linux-strip'
    set -g hu_bin '/app/bin/AppStandbyClock'
    set -g hu_share '/app/share/AppStandbyClock'
    ...
    set_color $medium; echo "killall AppStandbyClock"; set_color $reset
    ssh root@$ip_addr "killall AppStandbyClock"

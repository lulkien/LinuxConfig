function deploy-help
    ...
    # system variable
    set -g source_qml '/home/kienlh4ivi/working/source-code/AppHelp/qml'
    set -g release_bin '/home/kienlh4ivi/working/build/AppHelp/app/bin/AppHelp'
    set -g release_share '/home/kienlh4ivi/working/build/AppHelp/app/share/AppHelp'
    set -g strip_path '/usr/local/oecore-x86_64/sysroots/x86_64-oesdk-linux/usr/bin/x86_64-oe-linux/x86_64-oe-linux-strip'
    set -g hu_bin '/app/bin/AppHelp'
    set -g hu_share '/app/share/AppHelp'
    ...
    set_color $medium; echo "killall AppHelp"; set_color $reset
    ssh root@$ip_addr "killall AppHelp"
